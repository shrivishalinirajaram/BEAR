#Usage
#BEAR/run_bootstrapping_substep_1.sh input_file/Randomized.iris.data.2.class.csv 0.3 10 yes
...
rm -f -v BEAR/pipe_step_1_Bootstrapping/input_file/*
rm -f -v BEAR/pipe_step_1_Bootstrapping/output_feature_aggregates/*


python BEAR/scripts/Bootstrap_sampling_non_interactive.py $1 $2 $3 $4
